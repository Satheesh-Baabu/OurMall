...
import { ArrowRight, Filter, Home, RefreshCw, ShieldCheck, ShoppingBag, Sparkles } from "lucide-react";
import Button from "@/components/Button";

const featureCards = [
  {
    title: "Wide Selection",
    description: "Handpicked essentials across categories for every lifestyle.",
    icon: ShoppingBag,
  },
  {
    title: "Quality Products",
    description: "Curated items chosen for reliability and everyday functionality.",
    icon: ShieldCheck,
  },
  {
    title: "Easy Shopping",
    description: "Simple browsing, filtering, and checkout-ready product discovery.",
    icon: Filter,
  },
  {
    title: "Fast Experience",
    description: "Responsive, streamlined browsing designed to feel effortless.",
    icon: RefreshCw,
  },
];
    ...
    <main className="flex-1">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-body sm:text-lg">
              Browse our collection of trusted essentials and home favorites designed to make life simpler, smarter, and more enjoyable.
            </p>
      ...
      <section className="bg-primary/10 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-heading">Designed to make shopping easier</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-4xl bg-secondary px-6 py-10 text-center text-white sm:px-10 lg:px-16">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-white">Ready to shop</p>
          <h2 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl text-heading">Upgrade your everyday essentials.</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-200">
            Explore our catalog for home favorites, accessories, and practical finds designed to fit your routine.
          </p>
